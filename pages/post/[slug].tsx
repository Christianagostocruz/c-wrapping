      ...
      {formSubmited ? (
        <div className="my-10 mx-auto flex max-w-2xl flex-col bg-red-500 py-10 text-white">
          <h3 className="ml-2 text-3xl font-bold">
            Gracias ! su formulario enviado, se le enviara la cotización pronto.{' '}
          </h3>
        ...
        >
          ...
          <h4 className="text-3xl font-bold">Pide tu cotización gratis</h4>
          ...
          <label className="mb-5 block ">
            <span className="mb-10 text-gray-700 ">Teléfono</span>
            <input
          ...
          <label className="mb-5 block ">
            <span className="mb-10 text-gray-700 ">Correo electrónico</span>
            <input
          ...
          <label className="mb-5 block ">
            <span className="mb-10 text-gray-700 ">
              Descripción del trabajo que desea para su vehículo
            </span>
            <textarea
              {...register('comment', { required: true })}
              className="form-textarea mt-1 block w-full rounded border py-2 px-3 shadow outline-none ring-red-500 focus:ring"
              placeholder="Marca, Modelo, Año, Color que desea, Piezas o pieza que desea rotular."
              rows={8}
            />
          </label>
          <div className="flex flex-col p-5">
            ...
            {errors.phone && (
              <span className="text-red-500">
                Favor ingresar su teléfono en el formulario
              </span>
            )}
            {errors.email && (
              <span className="text-red-500">
                Favor ingresar su Correo electrónico en el formulario
              </span>
            )}
            {errors.comment && (
              <span className="text-red-500">
                Favor ingresar detalles de la cotización en el formulario
              </span>
            )}
          </div>
          <input
